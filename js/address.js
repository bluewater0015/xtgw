...
var addressInit = function(_cmbProvince, _cmbCity, defaultProvince, defaultCity, defaultArea)
{
...
{name:'台湾', cityList:[	{name: '台湾'}
]},
{name:'香港', cityList:[ {name: '香港'}
]},
{name:'澳门', cityList:[ {name: '澳门'}
]}
];